  ...
  const navActions = [
    {
      ...
      actions: [
        ...
        { id: "go-kandang", label: "Master Kandang", description: "Lintas peternak", leftSection: <IconBuildingWarehouse size={18} />, onClick: () => router.push("/dashboard/kandang") },
        ...
        { id: "go-aktivitas", label: "Aktivitas Sistem", description: "Audit trail", leftSection: <IconHistory size={18} />, onClick: () => router.push("/dashboard/aktivitas") },
      ],
    },
    {
      group: "Akun",
